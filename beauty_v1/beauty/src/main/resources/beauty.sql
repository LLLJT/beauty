...
INSERT INTO `blog` VALUES ('21', 'test blog', '21', '1', 'scsdca', '2020-05-09 23:41:11', null, '1', null, null, null, null, null, null, null, '1');
...
CREATE TABLE `blog_star` (
  ...
  `createtime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_star` (`userid`,`blogid`),
...
CREATE TABLE `user_follow` (
  ...
  `createtime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_follow` (`followerid`,`uploaderid`),
